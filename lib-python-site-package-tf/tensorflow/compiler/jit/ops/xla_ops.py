...
@_kwarg_only
def XlaClusterOutput(input):
  return xla_cluster_output(input=input)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def XlaLaunch(constants, args, resources, Tresults, function):
  return xla_launch(constants=constants, args=args, resources=resources, Tresults=Tresults, function=function)
