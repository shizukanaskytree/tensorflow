...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceGather(resource, indices, batch_dims, validate_indices, dtype):
  return resource_gather(resource=resource, indices=indices, batch_dims=batch_dims, validate_indices=validate_indices, dtype=dtype)
