...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def InfeedEnqueuePrelinearizedBuffer(input, device_ordinal):
  return infeed_enqueue_prelinearized_buffer(input=input, device_ordinal=device_ordinal)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Prelinearize(input, shape, layout):
  return prelinearize(input=input, shape=shape, layout=layout)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def PrelinearizeTuple(inputs, shapes, layouts):
  return prelinearize_tuple(inputs=inputs, shapes=shapes, layouts=layouts)
