...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MapDefun(arguments, captured_inputs, output_types, output_shapes, f, max_intra_op_parallelism):
  return map_defun(arguments=arguments, captured_inputs=captured_inputs, output_types=output_types, output_shapes=output_shapes, f=f, max_intra_op_parallelism=max_intra_op_parallelism)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ModelDataset(input_dataset, cpu_budget, output_types, output_shapes):
  return model_dataset(input_dataset=input_dataset, cpu_budget=cpu_budget, output_types=output_types, output_shapes=output_shapes)
