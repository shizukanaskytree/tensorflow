...
@_kwarg_only
def Batch(in_tensors, num_batch_threads, max_batch_size, max_enqueued_batches, batch_timeout_micros, allowed_batch_sizes, grad_timeout_micros, container, shared_name, batching_queue):
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BatchFunction(in_tensors, captured_tensors, f, num_batch_threads, max_batch_size, batch_timeout_micros, max_enqueued_batches, allowed_batch_sizes, container, shared_name, batching_queue, Tout):
  return batch_function(in_tensors=in_tensors, captured_tensors=captured_tensors, f=f, num_batch_threads=num_batch_threads, max_batch_size=max_batch_size, batch_timeout_micros=batch_timeout_micros, max_enqueued_batches=max_enqueued_batches, allowed_batch_sizes=allowed_batch_sizes, container=container, shared_name=shared_name, batching_queue=batching_queue, Tout=Tout)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Unbatch(batched_tensor, batch_index, id, timeout_micros, container, shared_name):
  return unbatch(batched_tensor=batched_tensor, batch_index=batch_index, id=id, timeout_micros=timeout_micros, container=container, shared_name=shared_name)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def UnbatchGrad(original_input, batch_index, grad, id, container, shared_name):
  return unbatch_grad(original_input=original_input, batch_index=batch_index, grad=grad, id=id, container=container, shared_name=shared_name)
