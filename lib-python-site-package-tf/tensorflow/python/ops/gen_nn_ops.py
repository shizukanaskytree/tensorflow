...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MaxPoolGradGradWithArgmax(input, grad, argmax, ksize, strides, padding, include_batch_in_index):
  return max_pool_grad_grad_with_argmax(input=input, grad=grad, argmax=argmax, ksize=ksize, strides=strides, padding=padding, include_batch_in_index=include_batch_in_index)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MaxPoolGradWithArgmax(input, grad, argmax, ksize, strides, padding, include_batch_in_index):
  return max_pool_grad_with_argmax(input=input, grad=grad, argmax=argmax, ksize=ksize, strides=strides, padding=padding, include_batch_in_index=include_batch_in_index)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MaxPoolWithArgmax(input, ksize, strides, Targmax, padding, include_batch_in_index):
  return max_pool_with_argmax(input=input, ksize=ksize, strides=strides, Targmax=Targmax, padding=padding, include_batch_in_index=include_batch_in_index)
