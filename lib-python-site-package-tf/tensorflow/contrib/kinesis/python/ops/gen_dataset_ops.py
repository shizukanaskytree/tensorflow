...
@_kwarg_only
def KinesisDataset(stream, shard, read_indefinitely, interval):
  return kinesis_dataset(stream=stream, shard=shard, read_indefinitely=read_indefinitely, interval=interval)
