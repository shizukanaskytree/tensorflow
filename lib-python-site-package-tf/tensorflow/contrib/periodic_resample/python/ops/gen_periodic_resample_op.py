...
@_kwarg_only
def PeriodicResample(values, shape):
  return periodic_resample(values=values, shape=shape)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def PeriodicResampleOpGrad(grad, original_shape, desired_shape):
  return periodic_resample_op_grad(grad=grad, original_shape=original_shape, desired_shape=desired_shape)
