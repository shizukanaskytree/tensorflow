...
@_kwarg_only
def IgniteDataset(cache_name, host, port, local, part, page_size, schema, permutation):
  return ignite_dataset(cache_name=cache_name, host=host, port=port, local=local, part=part, page_size=page_size, schema=schema, permutation=permutation)
