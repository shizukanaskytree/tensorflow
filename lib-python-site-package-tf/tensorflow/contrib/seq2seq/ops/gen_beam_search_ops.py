...
@_kwarg_only
def GatherTree(step_ids, parent_ids, max_sequence_lengths, end_token):
  return gather_tree(step_ids=step_ids, parent_ids=parent_ids, max_sequence_lengths=max_sequence_lengths, end_token=end_token)
