...
@_kwarg_only
def DecodeAudio(contents, file_format, samples_per_second, channel_count):
  return decode_audio(contents=contents, file_format=file_format, samples_per_second=samples_per_second, channel_count=channel_count)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DecodeAudioV2(contents, file_format, samples_per_second, channel_count, stream):
  return decode_audio_v2(contents=contents, file_format=file_format, samples_per_second=samples_per_second, channel_count=channel_count, stream=stream)
