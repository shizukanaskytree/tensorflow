...
@_kwarg_only
def EncodeAudio(sampled_audio, file_format, samples_per_second, bits_per_second):
  return encode_audio(sampled_audio=sampled_audio, file_format=file_format, samples_per_second=samples_per_second, bits_per_second=bits_per_second)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def EncodeAudioV2(sampled_audio, file_format, samples_per_second, bits_per_second):
  return encode_audio_v2(sampled_audio=sampled_audio, file_format=file_format, samples_per_second=samples_per_second, bits_per_second=bits_per_second)
