...
@_kwarg_only
def MaskedMatmul(a, b, mask_indices, transpose_a, transpose_b):
  return masked_matmul(a=a, b=b, mask_indices=mask_indices, transpose_a=transpose_a, transpose_b=transpose_b)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def WALSComputePartialLhsAndRhs(factors, factor_weights, unobserved_weights, input_weights, input_indices, input_values, entry_weights, input_block_size, input_is_transpose):
  return wals_compute_partial_lhs_and_rhs(factors=factors, factor_weights=factor_weights, unobserved_weights=unobserved_weights, input_weights=input_weights, input_indices=input_indices, input_values=input_values, entry_weights=entry_weights, input_block_size=input_block_size, input_is_transpose=input_is_transpose)
