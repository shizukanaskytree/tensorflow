...
@_kwarg_only
def BigQueryReader(container, shared_name, project_id, dataset_id, table_id, columns, timestamp_millis, test_end_point):
  return big_query_reader(container=container, shared_name=shared_name, project_id=project_id, dataset_id=dataset_id, table_id=table_id, columns=columns, timestamp_millis=timestamp_millis, test_end_point=test_end_point)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def GenerateBigQueryReaderPartitions(project_id, dataset_id, table_id, columns, timestamp_millis, num_partitions, test_end_point):
  return generate_big_query_reader_partitions(project_id=project_id, dataset_id=dataset_id, table_id=table_id, columns=columns, timestamp_millis=timestamp_millis, num_partitions=num_partitions, test_end_point=test_end_point)
