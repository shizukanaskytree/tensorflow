...
@_kwarg_only
def GcsConfigureBlockCache(max_cache_size, block_size, max_staleness):
  return gcs_configure_block_cache(max_cache_size=max_cache_size, block_size=block_size, max_staleness=max_staleness)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def GcsConfigureCredentials(json):
  return gcs_configure_credentials(json=json)
