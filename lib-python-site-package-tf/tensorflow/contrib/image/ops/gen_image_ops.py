...
@_kwarg_only
def BipartiteMatch(distance_mat, num_valid_rows, top_k):
  return bipartite_match(distance_mat=distance_mat, num_valid_rows=num_valid_rows, top_k=top_k)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ImageConnectedComponents(image):
  return image_connected_components(image=image)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ImageProjectiveTransform(images, transforms, interpolation):
  return image_projective_transform(images=images, transforms=transforms, interpolation=interpolation)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ImageProjectiveTransformV2(images, transforms, output_shape, interpolation):
  return image_projective_transform_v2(images=images, transforms=transforms, output_shape=output_shape, interpolation=interpolation)
