...
@_kwarg_only
def BucketizeWithInputBoundaries(input, boundaries):
  return bucketize_with_input_boundaries(input=input, boundaries=boundaries)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def CreateQuantileAccumulator(quantile_accumulator_handle, stamp_token, container, shared_name, max_elements, epsilon, num_quantiles, generate_quantiles):
  return create_quantile_accumulator(quantile_accumulator_handle=quantile_accumulator_handle, stamp_token=stamp_token, container=container, shared_name=shared_name, max_elements=max_elements, epsilon=epsilon, num_quantiles=num_quantiles, generate_quantiles=generate_quantiles)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MakeQuantileSummaries(dense_float_features, sparse_float_feature_indices, sparse_float_feature_values, sparse_float_feature_shapes, example_weights, epsilon):
  return make_quantile_summaries(dense_float_features=dense_float_features, sparse_float_feature_indices=sparse_float_feature_indices, sparse_float_feature_values=sparse_float_feature_values, sparse_float_feature_shapes=sparse_float_feature_shapes, example_weights=example_weights, epsilon=epsilon)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantileAccumulatorAddSummaries(quantile_accumulator_handles, stamp_token, summaries):
  return quantile_accumulator_add_summaries(quantile_accumulator_handles=quantile_accumulator_handles, stamp_token=stamp_token, summaries=summaries)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantileAccumulatorDeserialize(quantile_accumulator_handle, stamp_token, stream_state, are_buckets_ready, buckets):
  return quantile_accumulator_deserialize(quantile_accumulator_handle=quantile_accumulator_handle, stamp_token=stamp_token, stream_state=stream_state, are_buckets_ready=are_buckets_ready, buckets=buckets)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantileAccumulatorFlush(quantile_accumulator_handle, stamp_token, next_stamp_token):
  return quantile_accumulator_flush(quantile_accumulator_handle=quantile_accumulator_handle, stamp_token=stamp_token, next_stamp_token=next_stamp_token)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantileAccumulatorFlushSummary(quantile_accumulator_handle, stamp_token, next_stamp_token):
  return quantile_accumulator_flush_summary(quantile_accumulator_handle=quantile_accumulator_handle, stamp_token=stamp_token, next_stamp_token=next_stamp_token)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantileAccumulatorGetBuckets(quantile_accumulator_handles, stamp_token):
  return quantile_accumulator_get_buckets(quantile_accumulator_handles=quantile_accumulator_handles, stamp_token=stamp_token)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantileAccumulatorIsInitialized(quantile_accumulator_handle):
  return quantile_accumulator_is_initialized(quantile_accumulator_handle=quantile_accumulator_handle)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantileAccumulatorSerialize(quantile_accumulator_handle):
  return quantile_accumulator_serialize(quantile_accumulator_handle=quantile_accumulator_handle)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantileBuckets(dense_float_features, sparse_float_feature_indices, sparse_float_feature_values, sparse_float_feature_shapes, example_weights, dense_config, sparse_config):
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantileStreamResourceHandleOp(container, shared_name):
  return quantile_stream_resource_handle_op(container=container, shared_name=shared_name)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Quantiles(dense_values, sparse_values, dense_buckets, sparse_buckets, sparse_indices):
  return quantiles(dense_values=dense_values, sparse_values=sparse_values, dense_buckets=dense_buckets, sparse_buckets=sparse_buckets, sparse_indices=sparse_indices)
