...
@_kwarg_only
def CreateTreeEnsembleVariable(tree_ensemble_handle, stamp_token, tree_ensemble_config):
  return create_tree_ensemble_variable(tree_ensemble_handle=tree_ensemble_handle, stamp_token=stamp_token, tree_ensemble_config=tree_ensemble_config)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DecisionTreeEnsembleResourceHandleOp(container, shared_name):
  return decision_tree_ensemble_resource_handle_op(container=container, shared_name=shared_name)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TreeEnsembleDeserialize(tree_ensemble_handle, stamp_token, tree_ensemble_config):
  return tree_ensemble_deserialize(tree_ensemble_handle=tree_ensemble_handle, stamp_token=stamp_token, tree_ensemble_config=tree_ensemble_config)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TreeEnsembleIsInitializedOp(tree_ensemble_handle):
  return tree_ensemble_is_initialized_op(tree_ensemble_handle=tree_ensemble_handle)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TreeEnsembleSerialize(tree_ensemble_handle):
  return tree_ensemble_serialize(tree_ensemble_handle=tree_ensemble_handle)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TreeEnsembleStampToken(tree_ensemble_handle):
  return tree_ensemble_stamp_token(tree_ensemble_handle=tree_ensemble_handle)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TreeEnsembleUsedHandlers(tree_ensemble_handle, stamp_token, num_all_handlers):
  return tree_ensemble_used_handlers(tree_ensemble_handle=tree_ensemble_handle, stamp_token=stamp_token, num_all_handlers=num_all_handlers)
