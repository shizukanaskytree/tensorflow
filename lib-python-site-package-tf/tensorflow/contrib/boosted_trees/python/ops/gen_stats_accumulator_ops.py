...
@_kwarg_only
def CreateStatsAccumulatorScalar(stats_accumulator_handle, stamp_token):
  return create_stats_accumulator_scalar(stats_accumulator_handle=stats_accumulator_handle, stamp_token=stamp_token)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def CreateStatsAccumulatorTensor(stats_accumulator_handle, stamp_token, per_slot_gradient_shape, per_slot_hessian_shape):
  return create_stats_accumulator_tensor(stats_accumulator_handle=stats_accumulator_handle, stamp_token=stamp_token, per_slot_gradient_shape=per_slot_gradient_shape, per_slot_hessian_shape=per_slot_hessian_shape)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StatsAccumulatorScalarAdd(stats_accumulator_handles, stamp_token, partition_ids, feature_ids, gradients, hessians):
  return stats_accumulator_scalar_add(stats_accumulator_handles=stats_accumulator_handles, stamp_token=stamp_token, partition_ids=partition_ids, feature_ids=feature_ids, gradients=gradients, hessians=hessians)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StatsAccumulatorScalarDeserialize(stats_accumulator_handle, stamp_token, num_updates, partition_ids, feature_ids, gradients, hessians):
  return stats_accumulator_scalar_deserialize(stats_accumulator_handle=stats_accumulator_handle, stamp_token=stamp_token, num_updates=num_updates, partition_ids=partition_ids, feature_ids=feature_ids, gradients=gradients, hessians=hessians)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StatsAccumulatorScalarFlush(stats_accumulator_handle, stamp_token, next_stamp_token):
  return stats_accumulator_scalar_flush(stats_accumulator_handle=stats_accumulator_handle, stamp_token=stamp_token, next_stamp_token=next_stamp_token)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StatsAccumulatorScalarIsInitialized(stats_accumulator_handle):
  return stats_accumulator_scalar_is_initialized(stats_accumulator_handle=stats_accumulator_handle)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StatsAccumulatorScalarMakeSummary(partition_ids, feature_ids, gradients, hessians):
  return stats_accumulator_scalar_make_summary(partition_ids=partition_ids, feature_ids=feature_ids, gradients=gradients, hessians=hessians)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StatsAccumulatorScalarResourceHandleOp(container, shared_name):
  return stats_accumulator_scalar_resource_handle_op(container=container, shared_name=shared_name)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StatsAccumulatorScalarSerialize(stats_accumulator_handle):
  return stats_accumulator_scalar_serialize(stats_accumulator_handle=stats_accumulator_handle)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StatsAccumulatorTensorAdd(stats_accumulator_handles, stamp_token, partition_ids, feature_ids, gradients, hessians):
  return stats_accumulator_tensor_add(stats_accumulator_handles=stats_accumulator_handles, stamp_token=stamp_token, partition_ids=partition_ids, feature_ids=feature_ids, gradients=gradients, hessians=hessians)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StatsAccumulatorTensorDeserialize(stats_accumulator_handle, stamp_token, num_updates, partition_ids, feature_ids, gradients, hessians):
  return stats_accumulator_tensor_deserialize(stats_accumulator_handle=stats_accumulator_handle, stamp_token=stamp_token, num_updates=num_updates, partition_ids=partition_ids, feature_ids=feature_ids, gradients=gradients, hessians=hessians)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StatsAccumulatorTensorFlush(stats_accumulator_handle, stamp_token, next_stamp_token):
  return stats_accumulator_tensor_flush(stats_accumulator_handle=stats_accumulator_handle, stamp_token=stamp_token, next_stamp_token=next_stamp_token)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StatsAccumulatorTensorIsInitialized(stats_accumulator_handle):
  return stats_accumulator_tensor_is_initialized(stats_accumulator_handle=stats_accumulator_handle)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StatsAccumulatorTensorMakeSummary(partition_ids, feature_ids, gradients, hessians):
  return stats_accumulator_tensor_make_summary(partition_ids=partition_ids, feature_ids=feature_ids, gradients=gradients, hessians=hessians)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StatsAccumulatorTensorResourceHandleOp(container, shared_name):
  return stats_accumulator_tensor_resource_handle_op(container=container, shared_name=shared_name)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StatsAccumulatorTensorSerialize(stats_accumulator_handle):
  return stats_accumulator_tensor_serialize(stats_accumulator_handle=stats_accumulator_handle)
