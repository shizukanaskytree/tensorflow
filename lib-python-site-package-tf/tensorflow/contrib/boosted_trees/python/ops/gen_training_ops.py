...
@_kwarg_only
def CenterTreeEnsembleBias(tree_ensemble_handle, stamp_token, next_stamp_token, delta_updates, learner_config, centering_epsilon):
  return center_tree_ensemble_bias(tree_ensemble_handle=tree_ensemble_handle, stamp_token=stamp_token, next_stamp_token=next_stamp_token, delta_updates=delta_updates, learner_config=learner_config, centering_epsilon=centering_epsilon)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def GrowTreeEnsemble(tree_ensemble_handle, stamp_token, next_stamp_token, learning_rate, dropout_seed, max_tree_depth, weak_learner_type, partition_ids, gains, splits, learner_config, center_bias):
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TreeEnsembleStats(tree_ensemble_handle, stamp_token):
  return tree_ensemble_stats(tree_ensemble_handle=tree_ensemble_handle, stamp_token=stamp_token)
