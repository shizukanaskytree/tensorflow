...
@_kwarg_only
def BigtableClient(project_id, instance_id, connection_pool_size, max_receive_message_size, container, shared_name):
  return bigtable_client(project_id=project_id, instance_id=instance_id, connection_pool_size=connection_pool_size, max_receive_message_size=max_receive_message_size, container=container, shared_name=shared_name)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BigtableLookupDataset(keys_dataset, table, column_families, columns):
  return bigtable_lookup_dataset(keys_dataset=keys_dataset, table=table, column_families=column_families, columns=columns)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BigtablePrefixKeyDataset(table, prefix):
  return bigtable_prefix_key_dataset(table=table, prefix=prefix)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BigtableRangeKeyDataset(table, start_key, end_key):
  return bigtable_range_key_dataset(table=table, start_key=start_key, end_key=end_key)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BigtableSampleKeyPairsDataset(table, prefix, start_key, end_key):
  return bigtable_sample_key_pairs_dataset(table=table, prefix=prefix, start_key=start_key, end_key=end_key)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BigtableSampleKeysDataset(table):
  return bigtable_sample_keys_dataset(table=table)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BigtableScanDataset(table, prefix, start_key, end_key, column_families, columns, probability):
  return bigtable_scan_dataset(table=table, prefix=prefix, start_key=start_key, end_key=end_key, column_families=column_families, columns=columns, probability=probability)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BigtableTable(client, table_name, container, shared_name):
  return bigtable_table(client=client, table_name=table_name, container=container, shared_name=shared_name)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DatasetToBigtable(table, input_dataset, column_families, columns, timestamp):
  return dataset_to_bigtable(table=table, input_dataset=input_dataset, column_families=column_families, columns=columns, timestamp=timestamp)
