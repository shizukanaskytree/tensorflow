...
@_kwarg_only
def ReduceSliceMax(data, indices, axis):
  return reduce_slice_max(data=data, indices=indices, axis=axis)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReduceSliceMin(data, indices, axis):
  return reduce_slice_min(data=data, indices=indices, axis=axis)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReduceSliceProd(data, indices, axis):
  return reduce_slice_prod(data=data, indices=indices, axis=axis)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReduceSliceSum(data, indices, axis):
  return reduce_slice_sum(data=data, indices=indices, axis=axis)
