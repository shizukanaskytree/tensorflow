...
@_kwarg_only
def CreateTreeVariable(tree_handle, tree_config, params):
  return create_tree_variable(tree_handle=tree_handle, tree_config=tree_config, params=params)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DecisionTreeResourceHandleOp(container, shared_name):
  return decision_tree_resource_handle_op(container=container, shared_name=shared_name)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FeatureUsageCounts(tree_handle, params):
  return feature_usage_counts(tree_handle=tree_handle, params=params)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TraverseTreeV4(tree_handle, input_data, sparse_input_indices, sparse_input_values, sparse_input_shape, input_spec, params):
  return traverse_tree_v4(tree_handle=tree_handle, input_data=input_data, sparse_input_indices=sparse_input_indices, sparse_input_values=sparse_input_values, sparse_input_shape=sparse_input_shape, input_spec=input_spec, params=params)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TreeDeserialize(tree_handle, tree_config, params):
  return tree_deserialize(tree_handle=tree_handle, tree_config=tree_config, params=params)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TreeIsInitializedOp(tree_handle):
  return tree_is_initialized_op(tree_handle=tree_handle)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TreePredictionsV4(tree_handle, input_data, sparse_input_indices, sparse_input_values, sparse_input_shape, input_spec, params):
  return tree_predictions_v4(tree_handle=tree_handle, input_data=input_data, sparse_input_indices=sparse_input_indices, sparse_input_values=sparse_input_values, sparse_input_shape=sparse_input_shape, input_spec=input_spec, params=params)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TreeSerialize(tree_handle):
  return tree_serialize(tree_handle=tree_handle)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TreeSize(tree_handle):
  return tree_size(tree_handle=tree_handle)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def UpdateModelV4(tree_handle, leaf_ids, input_labels, input_weights, params):
  return update_model_v4(tree_handle=tree_handle, leaf_ids=leaf_ids, input_labels=input_labels, input_weights=input_weights, params=params)
