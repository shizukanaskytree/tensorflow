...
@_kwarg_only
def CreateFertileStatsVariable(stats_handle, stats_config, params):
  return create_fertile_stats_variable(stats_handle=stats_handle, stats_config=stats_config, params=params)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FertileStatsDeserialize(stats_handle, stats_config, params):
  return fertile_stats_deserialize(stats_handle=stats_handle, stats_config=stats_config, params=params)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FertileStatsIsInitializedOp(stats_handle):
  return fertile_stats_is_initialized_op(stats_handle=stats_handle)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FertileStatsResourceHandleOp(container, shared_name):
  return fertile_stats_resource_handle_op(container=container, shared_name=shared_name)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FertileStatsSerialize(stats_handle, params):
  return fertile_stats_serialize(stats_handle=stats_handle, params=params)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FinalizeTree(tree_handle, stats_handle, params):
  return finalize_tree(tree_handle=tree_handle, stats_handle=stats_handle, params=params)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def GrowTreeV4(tree_handle, stats_handle, finished_nodes, params):
  return grow_tree_v4(tree_handle=tree_handle, stats_handle=stats_handle, finished_nodes=finished_nodes, params=params)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ProcessInputV4(tree_handle, stats_handle, input_data, sparse_input_indices, sparse_input_values, sparse_input_shape, input_labels, input_weights, leaf_ids, random_seed, input_spec, params):
