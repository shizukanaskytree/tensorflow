...
@_kwarg_only
def ReinterpretStringToFloat(input_data):
  return reinterpret_string_to_float(input_data=input_data)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ScatterAddNdim(input, indices, deltas):
  return scatter_add_ndim(input=input, indices=indices, deltas=deltas)
