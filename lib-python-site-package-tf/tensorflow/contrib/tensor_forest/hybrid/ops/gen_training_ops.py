...
@_kwarg_only
def HardRoutingFunction(input_data, tree_parameters, tree_biases, max_nodes, tree_depth):
  return hard_routing_function(input_data=input_data, tree_parameters=tree_parameters, tree_biases=tree_biases, max_nodes=max_nodes, tree_depth=tree_depth)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def KFeatureGradient(input_data, tree_parameters, tree_biases, routes, layer_num, random_seed):
  return k_feature_gradient(input_data=input_data, tree_parameters=tree_parameters, tree_biases=tree_biases, routes=routes, layer_num=layer_num, random_seed=random_seed)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def KFeatureRoutingFunction(input_data, tree_parameters, tree_biases, layer_num, max_nodes, num_features_per_node, random_seed):
  return k_feature_routing_function(input_data=input_data, tree_parameters=tree_parameters, tree_biases=tree_biases, layer_num=layer_num, max_nodes=max_nodes, num_features_per_node=num_features_per_node, random_seed=random_seed)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RoutingFunction(input_data, tree_parameters, tree_biases, max_nodes):
  return routing_function(input_data=input_data, tree_parameters=tree_parameters, tree_biases=tree_biases, max_nodes=max_nodes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RoutingGradient(input_data, tree_parameters, tree_biases, routes, max_nodes):
  return routing_gradient(input_data=input_data, tree_parameters=tree_parameters, tree_biases=tree_biases, routes=routes, max_nodes=max_nodes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StochasticHardRoutingFunction(input_data, tree_parameters, tree_biases, tree_depth, random_seed):
  return stochastic_hard_routing_function(input_data=input_data, tree_parameters=tree_parameters, tree_biases=tree_biases, tree_depth=tree_depth, random_seed=random_seed)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StochasticHardRoutingGradient(input_data, tree_parameters, tree_biases, path_probability, path, tree_depth):
  return stochastic_hard_routing_gradient(input_data=input_data, tree_parameters=tree_parameters, tree_biases=tree_biases, path_probability=path_probability, path=path, tree_depth=tree_depth)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def UnpackPath(path, path_values):
  return unpack_path(path=path, path_values=path_values)
