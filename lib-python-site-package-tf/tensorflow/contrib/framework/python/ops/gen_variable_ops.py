...
@_kwarg_only
def ZeroInitializer(ref):
  return zero_initializer(ref=ref)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ZeroVarInitializer(var, dtype, shape):
  return zero_var_initializer(var=var, dtype=dtype, shape=shape)
