...
@_kwarg_only
def SkipGramGenerateCandidates(input_tensor, min_skips, max_skips, start, limit, emit_self_as_target, seed, seed2):
  return skip_gram_generate_candidates(input_tensor=input_tensor, min_skips=min_skips, max_skips=max_skips, start=start, limit=limit, emit_self_as_target=emit_self_as_target, seed=seed, seed2=seed2)
