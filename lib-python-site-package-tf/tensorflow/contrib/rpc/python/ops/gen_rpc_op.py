...
@_kwarg_only
def Rpc(address, method, request, protocol, fail_fast, timeout_in_ms):
  return rpc(address=address, method=method, request=request, protocol=protocol, fail_fast=fail_fast, timeout_in_ms=timeout_in_ms)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TryRpc(address, method, request, protocol, fail_fast, timeout_in_ms):
  return try_rpc(address=address, method=method, request=request, protocol=protocol, fail_fast=fail_fast, timeout_in_ms=timeout_in_ms)
