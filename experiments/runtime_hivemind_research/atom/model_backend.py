...
from atom.task_pool import TaskPool
from atom.utils.logging import get_logger
from atom.utils.nested import nested_compare, nested_flatten, nested_map, nested_pack
from atom.utils.tensor_descr import DUMMY_BATCH_SIZE, BatchTensorDescriptor
...
class ModelBackend:
    """
    ModelBackend is a wrapper around torch module interacting with Runtime.
