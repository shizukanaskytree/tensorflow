...
void ExecutorState::Process(TaggedNode tagged_node, int64 scheduled_nsec) {
  ...
  while (!inline_ready.empty()) {
    ...
    if (!launched_asynchronously) {
      ...
      // 1.
      // Study Case: https://gist.github.com/6ee969612e0fe6cb6ac85d4fa31f1816
      // xla 调试时的 XLA compiled op log: (按照执行顺序)
      ...
      // 2020-04-07 11:31:44.416696: I tensorflow/core/common_runtime/executor.cc:1912] Synchronous kernel done: 67 step -2806529841310458747 {{node cluster_2_1/xla_compile}} = _XlaCompile[Nresources=4, Targs=[DT_FLOAT, DT_FLOAT], Tconstants=[DT_INT32], _XlaHasReferenceVars=false, function=cluster_2[_XlaCompiledKernel=true, _XlaHasReferenceVars=false, _XlaNumConstantArgs=1, _XlaNumResourceArgs=4], must_compile=false, _device="/job:localhost/replica:0/task:0/device:GPU:0"](Conv2DBackpropFilter_3-0-PermConstNHWCToNCHW-LayoutOptimizer/clone_5, cluster_5_1/merge_oidx_2, sequential/dropout/dropout/random_uniform/RandomUniform, sequential_conv2d_2_biasadd_readvariableop_resource, sequential_conv2d_2_conv2d_readvariableop_resource, sequential_conv2d_3_biasadd_readvariableop_resource, sequential_conv2d_3_conv2d_readvariableop_resource) device: /job:localhost/replica:0/task:0/device:GPU:0
      // 2020-04-07 11:34:34.082277: I tensorflow/core/common_runtime/executor.cc:1912] Synchronous kernel done: 96 step -2806529841310458747 {{node cluster_3_1/xla_compile}} = _XlaCompile[Nresources=2, Targs=[DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_FLOAT], Tconstants=[DT_INT32, DT_INT32, DT_INT32], _XlaHasReferenceVars=false, function=cluster_3[_XlaCompiledKernel=true, _XlaHasReferenceVars=false, _XlaNumConstantArgs=3, _XlaNumResourceArgs=2], must_compile=false, _device="/job:localhost/replica:0/task:0/device:GPU:0"](sequential/dropout_1/dropout/mul_1-0-1-PermConstNCHWToNHWC-LayoutOptimizer, sequential/flatten/Const, Conv2DBackpropFilter_3-0-PermConstNHWCToNCHW-LayoutOptimizer/clone_6, cluster_2_1/merge_oidx_1, cluster_2_1/merge_oidx_6, sequential/dropout_1/dropout/random_uniform/RandomUniform, cluster_2_1/merge_oidx_8, sequential_dense_biasadd_readvariableop_resource, sequential_dense_matmul_readvariableop_resource) device: /job:localhost/replica:0/task:0/device:GPU:0
      // 2020-04-07 11:36:12.154725: I tensorflow/core/common_runtime/executor.cc:1912] Synchronous kernel done: 121 step -2806529841310458747 {{node cluster_0_1/xla_compile}} = _XlaCompile[Nresources=16, Targs=[DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_BOOL, DT_FLOAT, ..., DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_FLOAT], Tconstants=[DT_INT32, DT_INT32, DT_INT32, DT_INT32, DT_INT32, DT_INT32, DT_INT32, DT_INT32, DT_INT32, DT_INT32, DT_INT32, DT_INT32, DT_INT32, DT_INT32], _XlaHasReferenceVars=false, function=cluster_0[_XlaCompiledKernel=true, _XlaHasReferenceVars=false, _XlaNumConstantArgs=14, _XlaNumResourceArgs=16], must_compile=false, _device="/job:localhost/replica:0/task:0/device:GPU:0"](strided_slice/stack_1, loss/activation_5_loss/Const_1, ExpandDims/dim, Shape_10-0-0-DataFormatVecPermuteNCHWToNHWC-LayoutOptimizer, Conv2DBackpropFilter_3-0-PermConstNHWCToNCHW-LayoutOptimizer, ShapeN, ConstantFolding/ShapeN-matshapes-1, ShapeN_1, ConstantFolding/ShapeN_1-matshapes-1, ShapeN_2, ConstantFolding/ShapeN_2-matshapes-1, ConstantFolding/ShapeN_3-matshapes-1, ExpandDims/dim/clone_1, ExpandDims/dim/clone_8, IteratorGetNext/_18, cluster_2_1/merge_oidx_0, cluster_2_1/merge_oidx_1, cluster_3_1/merge_oidx_0, sequential/dropout_2/dropout/random_uniform/RandomUniform, cluster_3_1/merge_oidx_3, cluster_3_1/merge_oidx_4, cluster_3_1/merge_oidx_5, cluster_2_1/merge_oidx_9, cluster_2_1/merge_oidx_6, cluster_2_1/merge_oidx_5, cluster_2_1/merge_oidx_4, cluster_2_1/merge_oidx_3, cluster_2_1/merge_oidx_2, cluster_5_1/merge_oidx_4, cluster_5_1/merge_oidx_2, cluster_5_1/merge_oidx_1, cluster_5_1/merge_oidx_0, cluster_5_1/merge_oidx_5, rmsprop_rmsprop_update_mul_readvariableop_resource, rmsprop_rmsprop_update_1_mul_readvariableop_resource, rmsprop_rmsprop_update_10_mul_readvariableop_resource, rmsprop_rmsprop_update_11_mul_readvariableop_resource, rmsprop_rmsprop_update_2_mul_readvariableop_resource, rmsprop_rmsprop_update_3_mul_readvariableop_resource, rmsprop_rmsprop_update_4_mul_readvariableop_resource, rmsprop_rmsprop_update_5_mul_readvariableop_resource, rmsprop_rmsprop_update_6_mul_readvariableop_resource, rmsprop_rmsprop_update_7_mul_readvariableop_resource, rmsprop_rmsprop_update_8_mul_readvariableop_resource, rmsprop_rmsprop_update_9_mul_readvariableop_resource, rmsprop_cast_3_readvariableop_resource, sequential_dense_1_biasadd_readvariableop_resource, sequential_dense_1_matmul_readvariableop_resource, metrics_accuracy_assignaddvariableop_resource) device: /job:localhost/replica:0/task:0/device:GPU:0
      // 2020-04-07 11:37:39.728704: I tensorflow/core/common_runtime/executor.cc:1912] Synchronous kernel done: 150 step -2806529841310458747 {{node cluster_1_1/xla_compile}} = _XlaCompile[Nresources=27, Targs=[DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_FLOAT], Tconstants=[], _XlaHasReferenceVars=false, function=cluster_1[_XlaCompiledKernel=true, _XlaHasReferenceVars=false, _XlaNumConstantArgs=0, _XlaNumResourceArgs=27], must_compile=false, _device="/job:localhost/replica:0/task:0/device:GPU:0"](cluster_0_1/merge_oidx_0, cluster_0_1/merge_oidx_4, cluster_0_1/merge_oidx_5, cluster_0_1/merge_oidx_6, cluster_0_1/merge_oidx_7, cluster_0_1/merge_oidx_8, cluster_0_1/merge_oidx_9, cluster_0_1/merge_oidx_10, cluster_0_1/merge_oidx_11, cluster_0_1/merge_oidx_12, cluster_0_1/merge_oidx_13, cluster_0_1/merge_oidx_14, cluster_0_1/merge_oidx_15, rmsprop_cast_readvariableop_resource, rmsprop_cast_1_readvariableop_resource, rmsprop_cast_2_readvariableop_resource, sequential_conv2d_biasadd_readvariableop_resource, sequential_conv2d_conv2d_readvariableop_resource, sequential_conv2d_1_biasadd_readvariableop_resource, sequential_conv2d_1_conv2d_readvariableop_resource, sequential_conv2d_2_biasadd_readvariableop_resource, sequential_conv2d_2_conv2d_readvariableop_resource, sequential_conv2d_3_biasadd_readvariableop_resource, sequential_conv2d_3_conv2d_readvariableop_resource, sequential_dense_biasadd_readvariableop_resource, sequential_dense_matmul_readvariableop_resource, sequential_dense_1_biasadd_readvariableop_resource, sequential_dense_1_matmul_readvariableop_resource, rmsprop_rmsprop_update_10_mul_readvariableop_resource, rmsprop_rmsprop_update_11_mul_readvariableop_resource, rmsprop_rmsprop_update_8_mul_readvariableop_resource, rmsprop_rmsprop_update_9_mul_readvariableop_resource, rmsprop_rmsprop_update_6_mul_readvariableop_resource, rmsprop_rmsprop_update_7_mul_readvariableop_resource, rmsprop_rmsprop_update_4_mul_readvariableop_resource, rmsprop_rmsprop_update_5_mul_readvariableop_resource, rmsprop_rmsprop_update_2_mul_readvariableop_resource, rmsprop_rmsprop_update_3_mul_readvariableop_resource, rmsprop_rmsprop_update_mul_readvariableop_resource, rmsprop_rmsprop_update_1_mul_readvariableop_resource, ^cluster_0_1/data_as_ctrl, ^cluster_2_1/data_as_ctrl, ^cluster_3_1/data_as_ctrl, ^cluster_5_1/data_as_ctrl) device: /job:localhost/replica:0/task:0/device:GPU:0
      // 2020-04-07 11:38:45.185890: I tensorflow/core/common_runtime/executor.cc:1912] Synchronous kernel done: 160 step -2806529841310458747 {{node cluster_4_1/xla_compile}} = _XlaCompile[Nresources=4, Targs=[DT_INT32, DT_FLOAT, DT_FLOAT], Tconstants=[DT_INT32, DT_INT32, DT_INT32, DT_INT32], _XlaHasReferenceVars=false, function=cluster_4[_XlaCompiledKernel=true, _XlaHasReferenceVars=false, _XlaNumConstantArgs=4, _XlaNumResourceArgs=4], must_compile=false, _device="/job:localhost/replica:0/task:0/device:GPU:0"](loss/activation_5_loss/Const_1/clone_2, strided_slice/stack_1/clone_3, strided_slice/stack_1/clone_4, loss/activation_5_loss/Const_1/clone_7, Shape/_28, cluster_0_1/merge_oidx_1, cluster_0_1/merge_oidx_2, rmsprop_cast_4_readvariableop_resource, metrics_accuracy_assignaddvariableop_resource, metrics_accuracy_assignaddvariableop_1_resource, rmsprop_cast_1_readvariableop_resource, ^cluster_1_1/data_as_ctrl, ^metrics/accuracy/AssignAddVariableOp_1) device: /job:localhost/replica:0/task:0/device:GPU:0
      // 2020-04-07 11:41:10.391601: I tensorflow/core/common_runtime/executor.cc:1912] Synchronous kernel done: 26 step -2279524004878693505 {{node cluster_7_1/xla_compile}} = _XlaCompile[Nresources=13, Targs=[DT_FLOAT, DT_FLOAT], Tconstants=[DT_INT32, DT_INT32, DT_INT32, DT_INT32, DT_INT32, DT_INT32], _XlaHasReferenceVars=false, function=cluster_7[_XlaCompiledKernel=true, _XlaHasReferenceVars=false, _XlaNumConstantArgs=6, _XlaNumResourceArgs=13], must_compile=false, _device="/job:localhost/replica:0/task:0/device:GPU:0"](sequential/conv2d/Conv2D-0-PermConstNHWCToNCHW-LayoutOptimizer, sequential/activation_3/Relu-0-0-PermConstNCHWToNHWC-LayoutOptimizer, sequential/flatten/Const, metrics/accuracy/ArgMax/dimension, loss/activation_5_loss/Const_1, metrics/accuracy/ArgMax/dimension/clone_9, IteratorGetNext/_8, IteratorGetNext/_4, sequential_conv2d_biasadd_readvariableop_resource, sequential_conv2d_conv2d_readvariableop_resource, sequential_conv2d_1_biasadd_readvariableop_resource, sequential_conv2d_1_conv2d_readvariableop_resource, sequential_conv2d_2_biasadd_readvariableop_resource, sequential_conv2d_2_conv2d_readvariableop_resource, sequential_conv2d_3_biasadd_readvariableop_resource, sequential_conv2d_3_conv2d_readvariableop_resource, sequential_dense_biasadd_readvariableop_resource, sequential_dense_matmul_readvariableop_resource, sequential_dense_1_biasadd_readvariableop_resource, sequential_dense_1_matmul_readvariableop_resource, metrics_accuracy_assignaddvariableop_resource) device: /job:localhost/replica:0/task:0/device:GPU:0
      // 2020-04-07 11:42:11.098934: I tensorflow/core/common_runtime/executor.cc:1912] Synchronous kernel done: 41 step -2279524004878693505 {{node cluster_6_1/xla_compile}} = _XlaCompile[Nresources=2, Targs=[DT_INT32, DT_FLOAT, DT_FLOAT], Tconstants=[DT_INT32, DT_INT32, DT_INT32, DT_INT32], _XlaHasReferenceVars=false, function=cluster_6[_XlaCompiledKernel=true, _XlaHasReferenceVars=false, _XlaNumConstantArgs=4, _XlaNumResourceArgs=2], must_compile=false, _device="/job:localhost/replica:0/task:0/device:GPU:0"](loss/activation_5_loss/softmax_cross_entropy_with_logits/Slice/begin, loss/activation_5_loss/Const_1/clone_10, loss/activation_5_loss/softmax_cross_entropy_with_logits/Slice/begin/clone_11, loss/activation_5_loss/Const_1/clone_12, Shape/_2, cluster_7_1/merge_oidx_0, IteratorGetNext/_4, metrics_accuracy_assignaddvariableop_resource, metrics_accuracy_assignaddvariableop_1_resource, ^metrics/accuracy/AssignAddVariableOp_1) device: /job:localhost/replica:0/task:0/device:GPU:0
      ...
      // {{node cluster_7_1/xla_compile}}
      // {{node cluster_6_1/xla_compile}}
