...
// 1. struct TfGpuId_tag_ {};
// 2. typedef ::tensorflow::gtl::IntType<TfGpuId_tag_, int32> TfGpuId;
// So, TfGpuId is ::tensorflow::gtl::IntType<TfGpuId_tag_, int32>
// Essentially, IntType is a subset of traditional int type.
// IntType provides less functionality of int type to only do the work
// of logical ordinal number.
// For more description, please go to int_type.h
