...
查询被使用的情况:
(hm) wxf@seir19:~/tf2/tensorflow/tensorflow$ grep -wnr "CallOptions" --exclude="*DOC*"

* core/distributed_runtime/worker.h:48:
  * void GetStatusAsync(CallOptions* opts, const GetStatusRequest* request,

* core/distributed_runtime/master_session.cc:206:
