...
int main(int argc, char* argv[]) {
  ...
  string image = "/home/wxf/tf2/tensorflow/tensorflow/examples/ccifar/data/251.png";
  string graph =
      "/home/wxf/tf2/tensorflow/tensorflow/examples/ccifar/data/output_graph.pb";
  string labels =
      "/home/wxf/tf2/tensorflow/tensorflow/examples/ccifar/data/imagenet_comp_graph_label_strings.txt";
