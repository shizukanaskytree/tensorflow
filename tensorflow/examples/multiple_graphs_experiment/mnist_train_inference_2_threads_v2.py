...
def graph1_inference():
    ...
    with tf.Session() as sess:
        ...
        #                                                             Y: batch_y})
        #        print("G1 Step " + str(step) + ", Minibatch Loss= " + \
        #              "{:.4f}".format(loss) + ", Training Accuracy= " + \
        #              "{:.3f}".format(acc))

        #print("G1 Optimization Finished!")

        # Calculate accuracy for MNIST test images
        print("G1 Testing Accuracy:", \
...
# The purpose of delay here is:
# To simulate that the inference tasks come in the middle of training task.
time.sleep(0.5)

for i in range(num_infer_threads):
    infer_workers[i].start()

print('Sent all Inference Tasks')
